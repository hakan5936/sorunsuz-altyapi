  ...
  **[${prefix}komut](kullanımı)**
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Genel').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Davet Et](Botunuzun Davet linki)` + "** | **" + `[Destek Sunucusu](sunucunuz)`  + "** | **" + `[Web Sitesi](ÇALIŞMA AŞAMASINDA)  `, false)
  ...
  **[${prefix}komut](kullanımı)**
  ...
  if(args[0] === "Sahip" || args[0] === "sahip" ) {
   ...
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Sahip').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
         .addField("» Linkler", ` [Davet Et](Botunuzun Davet Linki)` + "** | **" + `[Destek Sunucusu](sunucunuz)`  + "** | **" + `[Oy Ver](kapalı)`  + "** | **" + `[Web Sitesi](ÇALIŞMA AŞAMASINDA)  `, false)
...
//YARDIM KOMUTU
  ...
  .addField('Kategoriler:', `
  **[${prefix}yardım Genel](sunucunuzun davet linki)** 
  **[${prefix}yardım Sunucu](sunucunuzun davet linki)**
  **[${prefix}yardım Sahip](sunucunuzun davet linki)**
  **[${prefix}yardım Moderasyon](sunucunuzun davet linki)**
  **[${prefix}yardım Eğlence](sunucunuzun davet linki)**
  `)
  .addField("» Linkler", ` [Davet Et](Botunuzun Davet Linki)` + "** | **" + `[Destek Sunucusu](sunucunuz)`  + "** | **" + `[Web Sitesi](ÇALIŞMA AŞAMASINDA)  `, false)
